...
Devise.setup do |config|
  ...
  config.mailer_sender = "Project Lectito "
  ...
  # config.pepper = "8e85fb09ba3d135df6101dac6b2743d82a53c55b1d05945edecd029889a726882318c46dc18fde325a81677034e12803d51a003a255acf82da1cb143f35e8c73"
  ...
  #  config.email_regexp = /(?=.{9,})(?=.*?[^\w\s])(?=.*?[0-9])(?=.*?[A-Z]).*?[a-z].*/
