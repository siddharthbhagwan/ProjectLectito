...
ActiveRecord::Schema.define(version: 20140312120215) do
  ...
  create_table "users", force: true do |t|
    ...
    t.integer  "otp"
    t.integer  "otp_failed_attempts"
    t.boolean  "otp_verification",       default: false
    t.datetime "otp_failed_timestamp"
